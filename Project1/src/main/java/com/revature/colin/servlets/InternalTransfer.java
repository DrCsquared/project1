...
/**
 * Servlet implementation class InternalTransfer
 */
public class InternalTransfer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form action=\"internalTransferComplete\" method=\"post\" class=\"form-inline\">\r\n"
				...
				+ "  <br><br><br>"
				+ "    <div align=\"center\">\r\n"
				+ "        <p>Select account you want to transfer to.</p>\r\n"
				+ "    </div>\r\n"
				+ "    <div class=\"form-check\" >\r\n"
				+ "    <label class=\"form-check-label\">\r\n"
