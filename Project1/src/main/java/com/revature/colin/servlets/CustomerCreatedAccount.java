...
/**
 * Servlet implementation class CustomerCreatedAccount
 */
public class CustomerCreatedAccount extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerCreatedAccount() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			out.println(main.createAccountWeb(amount, radioOption));
