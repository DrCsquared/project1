...
/**
 * Servlet implementation class InternalTransferComplete
 */
public class InternalTransferComplete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InternalTransferComplete() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fromAccount = request.getParameter("optradio1");
		String toAccount = request.getParameter("optradio2");
		String amount = request.getParameter("amount");
		out.println(headingSetUp());
		try {
			out.println(main.internalTransactionWeb(amount, fromAccount, toAccount));
