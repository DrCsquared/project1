...
/**
 * Servlet implementation class ApproveCustomerTransaction
 */
public class ApproveCustomerTransaction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApproveCustomerTransaction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			out.println(main.customerApproveTransactionWeb(i));
