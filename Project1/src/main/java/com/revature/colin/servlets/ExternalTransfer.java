...
/**
 * Servlet implementation class ExternalTransfer
 */
public class ExternalTransfer extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form action=\"externalTransferComplete\" method=\"post\" class=\"form-inline\">"
				+ "<div class=\"container\" style=\"width: 35%\">"
				+ "    <div align=\"center\">"
				+ "        <p>Select account you want to transfer from.</p>"
				+ "    </div>"
				+ "    <div class=\"form-check\" >"
				+ "    <label class=\"form-check-label\">"
				+ "      <input type=\"radio\" class=\"form-check-input\" name=\"optradio1\" value=\"Checking\">Checking"
				+ "    </label>"
				+ "  </div>"
				+ "  <div class=\"form-check\" >"
				+ "    <label class=\"form-check-label\">"
				+ "      <input type=\"radio\" class=\"form-check-input\" name=\"optradio1\" value=\"Savings\">Savings"
				+ "    </label>"
				+ "  </div>"
				+ "  <br><br><br>"
				+ "    <div align=\"center\">"
				+ "        <p>Select the User type of account you want to transfer to.</p>"
				+ "    </div>"
				+ "    <div class=\"form-check\" >"
				+ "    <label class=\"form-check-label\">"
				+ "      <input type=\"radio\" class=\"form-check-input\" name=\"optradio2\" value=\"Checking\">Checking"
				+ "    </label>"
				+ "  </div>"
				+ "  <div class=\"form-check\" >"
				+ "    <label class=\"form-check-label\">"
				+ "      <input type=\"radio\" class=\"form-check-input\" name=\"optradio2\" value=\"Savings\">Savings"
				+ "    </label>"
				+ "  </div>"
