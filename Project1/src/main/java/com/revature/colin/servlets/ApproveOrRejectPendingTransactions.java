...
/**
 * Servlet implementation class ApproveOrRejectPendingTransactions
 */
public class ApproveOrRejectPendingTransactions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApproveOrRejectPendingTransactions() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String approveOrReject = request.getParameter("optradio1");
		
		out.println(headingSetUp());
		out.println(main.externalApproveOrReject(transactionNumber,approveOrReject));
