...
/**
 * Servlet implementation class WithdrawalConfirmPage
 */
public class WithdrawalConfirmPage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WithdrawalConfirmPage() 
    {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			out.println(main.withdrawalAccountWeb(amount, radioOption));
