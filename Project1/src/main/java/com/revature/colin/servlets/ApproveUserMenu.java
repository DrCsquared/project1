...
/**
 * Servlet implementation class ApproveUserMenu
 */
public class ApproveUserMenu extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApproveUserMenu() {
        super();
...
PrintWriter out = response.getWriter();
		...
		try {
			out.println(main.employeeUserApprovalWeb());
