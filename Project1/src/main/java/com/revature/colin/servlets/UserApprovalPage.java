...
/**
 * Servlet implementation class UserApprovalPage
 */
public class UserApprovalPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			out.println(main.employeeApproveOrDeclineUserWeb(user_id,radioOption));
