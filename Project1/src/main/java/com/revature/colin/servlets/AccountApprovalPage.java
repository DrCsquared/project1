...
/**
 * Servlet implementation class AccountApprovalPage
 */
public class AccountApprovalPage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccountApprovalPage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String radioOption = request.getParameter("optradio");
		out.println(headingSetUp());
		try {
			out.println(main.employeeApproveOrDeclineAccountWeb(account_ID,radioOption));
