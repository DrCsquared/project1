...
/**
 * Servlet implementation class CustomerPendingTransactions
 */
public class CustomerPendingTransactions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerPendingTransactions() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		main.setTransactionNumber(transactionID);
		
		out.println(headingSetUp());
		
		try {
			out.println(main.customerPendingTransactionsWeb(main.getCurrentUser()));
	...
	{
		String backToCustomerMenu = "<br><div class=\"container\" style=\"width: 25%\">\r\n"
				+ "\r\n"
